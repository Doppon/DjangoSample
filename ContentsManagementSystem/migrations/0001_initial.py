# Generated by Django 2.0.4 on 2018-04-14 13:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('book', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='impressions', to='ContentsManagementSystem.Book', verbose_name='書籍')),
            ],
        ),
    ]
